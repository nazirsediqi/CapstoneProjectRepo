...
public class CommonUtility extends BaseSetup {
	...
	public void clearTextNameOnCard(WebElement editNameOnCard, String value) {
		this.waitTillPresence(editNameOnCard).clear();
	}
	public void clearTextSecCode(WebElement editSecCod, String value) {
		this.waitTillPresence(editSecCod).clear();
	}
	public void clearTextAdd(WebElement fullName, String value) {
		this.waitTillPresence(fullName).clear();
	}
